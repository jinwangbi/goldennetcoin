...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Goldennetcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"223.75.10.249", "223.75.10.249"},
    {"121.40.161.53", "121.40.161.53"},
    {"122.244.158.68", "122.244.158.68"},
    {"115.159.64.172", "115.159.64.172"},
    {"45.79.201.62", "45.79.201.62"},
    //{NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Goldennetcoin is probably already running."), addrBind.ToString().c_str());
        else
