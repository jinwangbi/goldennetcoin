...
extern json_spirit::Value gettxdeposit(const json_spirit::Array& params, bool fHelp); //mozz server
extern json_spirit::Value getblockdeposit(const json_spirit::Array& params, bool fHelp); //mozz server
